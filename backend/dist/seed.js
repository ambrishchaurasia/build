...
async function main() {
    logger_1.logger.info("Initializing database seeding...");
    // Clean old records
    ...
    logger_1.logger.info("Database seeding successfully completed!");
    await prisma.$disconnect();
}
main().catch((err) => {
    logger_1.logger.error("Seeding operation failed", err);
    prisma.$disconnect();
    process.exit(1);
});
